...
class RecommendationPerformanceManager(AzureBaseManager):
    ...
    cloud_service_type = "Performance"
    ...
    def create_cloud_service(self, options: dict, secret_data: dict, schema: str):
        ...
        subscriptions_conn = SubscriptionsConnector(secret_data=secret_data)

        subscription_obj = subscriptions_conn.get_subscription(secret_data["subscription_id"])
